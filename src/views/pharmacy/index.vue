<template>
  ...
  <div class="div1">
    ...
    <el-aside width="400px" v-show="isaside" style="padding:0 0 0 0">
      <div>
      <el-card style="width:400px">
        <el-form inline>
          <el-form-item label="查询患者名">
            <el-input placeholder="患者名" style="width: 180px;" v-model="searchpatient" />
          </el-form-item>
          <el-form-item>
      ...
      <aside style="background-color: #fff">
        <el-form inline>
          ...
          <el-form-item label="当前患者">
            <el-tag class="painfo" color="white" style="width:100px;font-family:'微软雅黑'">姓名: <span style="color:black;">{{patient.patientName}}</span></el-tag>
          </el-form-item>
          <el-form-item>
            <el-tag class="painfo" color="white" style="width:200px;font-family:'微软雅黑'">就诊号: <span style="color:black">{{patient.medicalRecordNo}}</span></el-tag>
          </el-form-item>
          <el-form-item>
            <el-button type="success" plain  @click="sendDrug"><svg-icon icon-class="skill" />发药</el-button>
          </el-form-item>
        </el-form>
      </aside>
      <el-table height="600px" border stripe highlight-current-row :data="druglist" style="margin-left:10px;margin-top: -30px" :span-method="objectSpanMethod" @selection-change="changedep">
        ...
        <el-table-column align="center" label="使用建议">
          <template slot-scope="scope">
            {{scope.row.medicalAdvice}}
          </template>
        </el-table-column>
    ...
    <el-main style="padding:0 0 0 0" v-show="isGiven">
      ...
      <el-table height="600px" border stripe highlight-current-row :data="druglistgiven" style="margin-left:10px">
        <el-table-column align="center"  label="处方id">
          <template slot-scope="scope">
            {{scope.row.id}}
          </template>
        </el-table-column>
        <el-table-column align="center" label="药品名" width="200px">
          <template slot-scope="scope">
            {{scope.row.drugName}}
          </template>
        </el-table-column>
        ...
        <el-table-column align="center" label="已退药数量">
          <template slot-scope="scope">
            {{scope.row.refundNum}}
          </template>
        </el-table-column>
