<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input v-model="listQuery.code" placeholder="科室编码" style="width: 150px;" class="filter-item"
                @keyup.enter.native="handleFilter"/>
      <el-input v-model="listQuery.name" placeholder="科室名称" style="width: 150px;" class="filter-item"
                @keyup.enter.native="handleFilter"/>
      <el-select v-model="listQuery.catId" placeholder="科室分类" clearable style="width: 130px" class="filter-item"
                 filterable>
        <el-option v-for="item in allCatId" :key="item" :label="item" :value="item"/>
      </el-select>
      <el-select v-model="listQuery.type" placeholder="科室类别" clearable class="filter-item" style="width: 130px"
                 filterable>
      ...
      <el-button size="small" v-waves :loading="downloadLoading" class="filter-item" type="primary"
                 icon="el-icon-download"
                 @click="handleDownload">
        导出科室
      </el-button>
      <el-button size="small" type="primary" icon="el-icon-upload2" class="filter-item" @click="uploaddept">导入科室
      </el-button>
      <el-button size="small" v-waves :loading="downloadLoading" class="filter-item" type="danger"
                 icon="el-icon-download"
                 @click="handleSomeDelete">
        批量删除
      </el-button>
    </div>
    <!--科室列表 -->
    <el-table v-loading="listLoading" :data="depList" style="width: 100%;margin-top:30px;" border
              @selection-change="changedep">
    ...
    <el-dialog :visible.sync="dialogVisible" width="500px" :title="dialogType==='edit'?'修改科室信息':'新增科室'"
               @close="getDeplist">
    ...
    <pagination v-show="total>0" :total="total" :page.sync="listQuery.page" :limit.sync="listQuery.limit"
                @pagination="getDeplist" style="margin-top: -20px"/>
