<template>
  ...
  <div v-if="!showdetail" class="app-container" style="text-align:center">
    ...
    <el-table v-loading="listLoading" :data="ruleList" style="width: 100%;margin-top:10px;"  stripe border @selection-change="changerule">
    ...
    <pagination style="margin-top: -20px" v-show="total>0" :total="total" :page.sync="listQuery.pageNum" :limit.sync="listQuery.pageSize" @pagination="getRuleList" />
