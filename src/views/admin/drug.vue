<template>
  <div class="app-container">
    ...
    <!--药品列表 -->
    <el-table v-loading="listLoading" :data="drugList" style="width: 100%;margin-top:10px;" border @selection-change="changedep">
    ...
    <pagination style="margin-top: -20px" v-show="total>0" :total="total" :page.sync="listQuery.pageNum" :limit.sync="listQuery.pageSize" @pagination="getdrugList" />
  </div>
</template>
