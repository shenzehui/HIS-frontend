  ...
  <el-container>
      ...
      <el-main width="50%" v-show="isclose"
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="检查模板" name="first">
            ...
            <el-table highlight-current-row @row-dblclick="addModel" @row-click="selectModel" stripe :data="checkmodels"
                      height="230">
    ...
    <el-dialog title="检查目录" :visible.sync="dialogTableVisible" top="50px">
      <div style="height:450px">
        ...
        <el-table height="400px" @row-click="selectCheck" highlight-current-row
                  :data="checkList.filter(data => !search || data.name.toLowerCase().includes(search.toLowerCase())||data.code.toLowerCase().includes(search.toLowerCase()))"
      ...
      <div style="height:260px">
        <el-form inline label-width="100px">
          <el-form-item label="项目编码">
            <el-input disabled placeholder="" v-model="check.code"></el-input>
          </el-form-item>
          <el-form-item label="项目名称">
            <el-input disabled placeholder="" v-model="check.name"></el-input>
          </el-form-item>
          <el-form-item label="执行科室">
            <el-input disabled placeholder="" v-model="check.deptName"></el-input>
          </el-form-item>
          <el-form-item label="目的">
            <el-input placeholder="" v-model="check.aim"></el-input>
          </el-form-item>
          <el-form-item label="要求">
            <el-input placeholder="" v-model="check.demand"></el-input>
          </el-form-item>
          <el-form-item label="临床印象">
            <el-input placeholder="" v-model="check.clinicalImpression"></el-input>
          </el-form-item>
          <el-form-item label="临床诊断">
            <el-input placeholder="" v-model="check.clinicalDiagnosis"></el-input>
          </el-form-item>
          <el-form-item label="检查部位">
            <el-input placeholder="" v-model="check.checkParts"></el-input>
          </el-form-item>
        </el-form>
