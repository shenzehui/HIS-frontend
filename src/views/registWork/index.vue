  ...
  <div>
    <aside>
      ...
      <el-input
        ...
        class="filter-item"
      ></el-input>
      <el-button v-show="isshow" size="mini" @click="createUUID"
        >生成发票号
      </el-button>
      <el-input
        size="mini"
      ...
      <el-button
        ...
        size="medium"
        @click="reprint"
        ><i class="el-icon-circle-plus" />重打
      </el-button>
      <el-button
        style="float:right;margin-left:20px"
        type="text"
      ...
      <transition name=".el-fade-in-linear">
        ...
        >
          ...
          <el-form-item style="margin-left:940px">
            <el-button type="primary" @click="createRegistration"
              >挂号&打印发票
            </el-button>
          </el-form-item>
        </el-form>
    ...
    <div v-if="!dialogFormVisible && !isshow && !refundVisible">
      <el-button
        style="margin-left:20px;font-family:'微软雅黑';font-size:14px;color:black"
        disabled
        >挂号信息列表
      </el-button>
      <el-input
        ...
        <el-table-column fixed="left" label="操作" width="160" align="center">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              plain
              size="mini"
              @click="refundRegistrationCharge(scope.row)"
              >退费
            </el-button>
            <el-button
    ...
    <el-dialog title="退号" :visible.sync="refundregistVisible" width="400px">
      <el-form :model="refundregist">
        ...
        <el-form-item>
          ...
          <el-button style="float:right" type="primary" @click="comfirmtuihao"
            >退号
          </el-button>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="补打" :visible.sync="suppregistVisible" width="400px">
      <el-form :model="refundregist">
        ...
        <el-form-item>
          ...
          <el-button style="float:right" type="primary" @click="supprint2"
            >退号
          </el-button>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    createUUID() {
      this.dmsRegistrationParam.invoiceNo = Math.floor(1000000 * Math.random());
    },
    supprint(val) {
    ...
    createRegistration() {
      if (
        this.dmsRegistrationParam.invoiceNo === "" ||
        this.dmsRegistrationParam.invoiceNo === undefined
      ) {
        this.$notify({
          title: "信息不完整",
          message: "请输入发票号！",
    ...
    chooseRegister(val) {
      if (
        this.dmsRegistrationParam.RegisterRnak === 1 &&
        this.dmsRegistrationParam.attendanceDate !== "" &&
