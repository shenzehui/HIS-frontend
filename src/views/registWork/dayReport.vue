...
import {dailySettle, queryInvoiceInfo, queryRecentEndDatetime, querySettleDetailById} from '@/api/dayreport'
...
export default {
  ...
  methods: {
    ...
    dailySettle() {
      ...
      data.cashierId = this.$store.getters.id
      data.startDatetime = parseTime(this.starttime)
      this.endtime === '' ? data.endDatetime = '2024-01-1 00:00:00' : parseTime(this.endtime)
