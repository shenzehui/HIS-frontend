...
<!--        </aside>-->
      ...
      <el-container style="border-style: dotted;border-width: 1px 0px 0px 0px;border-color:#C0C0C0;">
      <el-aside width="30%" style="border-style: dotted;border-width: 0px 1px 0px 0px;border-color:#C0C0C0;background:white">
        <el-tabs value="first">
