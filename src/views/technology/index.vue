<template>
  ...
  <div class="div1">
      <aside style="background-color: #fff">
        <el-input v-model="search" placeholder="病历号/姓名" style="width: 180px;margin-left:10px;margin-top: 10px" class="filter-item input1" />
        <el-button><svg-icon icon-class="search" @click="getMechlist" /></el-button>
      </aside>
